...
<div id="ja-wrapper">
  ...
  <div id="ja-headerwrap">
    <div class="clearfix" id="ja-header"> <a href="http://120.25.60.106/fzusj/"> 
	<img src="images/head.jpg" alt="数学与计算机科学学院" width="100%" height="100%"/> </a> </div>
  </div>
  <!--end-->
  <!--头部导航-->
  ...
  <div id="ja-containerwrap">
	...
	-->
      <iframe frameborder="0" height="1400px" width="950px" src="rili.php" name="myframe"></iframe>
    </center>
  </div>
  <!--底部-->
  <div id="ja-footerwrap">
    <div class="clearfix" id="ja-footer"> <a href="http://cmcs.fzu.edu.cn/">学院网站</a> | <a href="http://www.fjrclh.com/">福州大学就业指导中心</a>| <a href="http://weibo.com/1729859463/">Designed & Developed  By 陈泽泽</a> <br />
