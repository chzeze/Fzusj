  ...
  <center>
    <form class="form-inline">
      ...
      <p> 相关链接：
        ...
        <span>&nbsp;</span> </p>
      <p> 详细信息:
        <textarea id="detail" name="content" class="form-control" style="width:800px;height:400px;visibility:hidden;" placeholder="用于跳转详情面信息..."><?=$var_detail?></textarea>
      </p>
	  <input id=id type="hidden" value="<?=$infoid?>">
      <button id=submit class="btn btn-success" type="button">修改</button><br/>
<a href=modify2.php?inid=<?php echo $_GET['inid']?>><font style="color:blue" size="3"><br/>进入纯文本编辑模式</font></a>
